...
void StringElement::_GetValueLength(int messageId, int valueNumber, unsigned long& bufferLength)
{
...
void StringElement::_GetStringValue(int messageId, unsigned long bufferLength, char* buffer, bool multipleValues)
{
	MC_STATUS status;
...
void StringElement::GetValues(int messageId)
{
	MC_STATUS status;
